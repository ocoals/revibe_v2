...
const Splash = ({onDone}) => {
  ...
  return <div style={ph}>
    <div style={{height:"100%",background:C.white,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
      <div style={{opacity:0,animation:"fi .6s ease .3s forwards"}}>
        <div style={{display:"flex",alignItems:"center",gap:3}}>
          <span style={{fontSize:72,fontWeight:800,color:C.primary,fontFamily:"Georgia,serif",lineHeight:1}}>R</span>
          <div style={{display:"flex",flexDirection:"column",gap:7,marginTop:4}}>
            <div style={{width:13,height:13,borderRadius:"50%",background:C.primary}}/>
            <div style={{width:13,height:13,borderRadius:"50%",background:C.primary,opacity:0.35}}/>
          </div>
        </div>
      </div>
      <p style={{fontSize:18,color:C.ter,fontWeight:600,letterSpacing:6,marginTop:20,opacity:0,animation:"fi .6s ease .6s forwards",fontFamily:"Georgia,serif"}}>RE:VIBE</p>
    </div>
